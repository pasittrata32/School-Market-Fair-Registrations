...
const translations = {
  th: {
    ...
    registrationClosedMessage: 'ระบบได้ปิดรับลงทะเบียนอัตโนมัติแล้ว ตามกำหนดในวันที่ 27 สิงหาคม 2568 เวลา 09.00 น.',
  ...
  en: {
    ...
    registrationClosedMessage: 'Registration has been automatically closed on August 27, 2025 at 9:00 AM as scheduled.',
  ...
  return (
    <motion.div 
      ...
      className="bg-white border border-slate-200 rounded-2xl form-soft-shadow overflow-hidden w-full">
        ...
        <div className="p-8 text-center relative bg-sky-600">
            <MotionButton onClick={toggleLanguage} className="absolute top-6 right-6 bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-full transition-colors text-sm font-semibold flex items-center shadow-sm">
                <span>{t.langBtn}</span>
            </MotionButton>
